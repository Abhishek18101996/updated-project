<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.skillIndia.model.Establishment" session="true"%>
<!DOCTYPE html>
<html>
...
<br><br>
<a href="signoute">Signout</a>

 
<a href="listCourse">List Courses</a>
<a href="addCourse">AddCourses</a>
<a href="candidatestatus">View Status</a>
<a href="candidateList">List Candidates</a>
